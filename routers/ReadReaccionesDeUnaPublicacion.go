...
/*ReadReaccionesDeUnaPublicacion servira para leer todas las publicaciones*/
func ReadReaccionesDeUnaPublicacion(w http.ResponseWriter, r *http.Request) {
	...
	pag := int64(page)*/
	respuesta, correct := bd.ReadReaccionesDeUnaPublicacion()
	if correct == false {
